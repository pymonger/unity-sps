...
ecm_vic_dataset = DatasetAlias("ECM_VIC")
png_dataset = DatasetAlias("PNG")
...
with DAG(
    ...
    @task(inlets=[edr_vic_dataset, ecm_vic_dataset])
    def prep(params: dict, inlet_events=None):
            ...
            for i in ["stage-in", "stage-out"]:
                ...
                if i == "stage-in":
                    ...
                    for k, v in params.items():
                        ...
                        inlet_events["ECM_VIC" if "ECM" in v else "EDR_VIC"].add(Dataset(v))
    ...
    def post(params: dict, outlet_events=None):
        ...
        for i in output_urls:
            outlet_events["PNG"].add(Dataset(i))
        return output_urls
